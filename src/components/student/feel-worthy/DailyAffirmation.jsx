...
//                 <div 
//                   className={`text-2xl md:text-3xl font-medium text-gray-800 mb-8 min-h-[120px] flex items-center justify-center transition-opacity duration-500 ${isChanging ? 'opacity-0' : 'opacity-100'}`}
//                 >
//                   "{currentAffirmation}"
//                 </div>
